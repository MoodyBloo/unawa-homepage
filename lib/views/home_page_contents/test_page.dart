...
import 'package:unawa_home_page/views/home_page_contents/test_page_contents/test_all_page.dart';
import 'package:unawa_home_page/views/home_page_contents/test_page_contents/test_alphabet_page.dart';
import 'package:unawa_home_page/views/home_page_contents/test_page_contents/test_phrases_page.dart';
            ...
            child: Column(
              children: [
                _buildLearnOption(
                  ...
                  title: 'Test Alphabet',
                  description: 'Test your knowledge of the alphabet in sign language',
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                _buildLearnOption(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const TestAllPage(), // Adjust if needed
                      ),
                    );
                  },
                ),
