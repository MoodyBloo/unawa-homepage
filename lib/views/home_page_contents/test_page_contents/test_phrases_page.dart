...
import 'package:unawa_home_page/utils/unawa_card.dart';
import 'package:unawa_home_page/views/home_page_contents/test_page.dart';
import 'package:unawa_home_page/views/home_page_contents/test_page_contents/test_completion_page.dart'; // Update import path if necessary
...
class _TestPhrasesPageState extends State<TestPhrasesPage> {
  ...
  void generateChoices() {
    List<List<String>> tempChoices = [
      ['Kumusta', 'Magandang Araw', 'Salamat', 'Mahal Kita'], // Choices for first image
      ['Salamat', 'Mahal Kita', 'Paalam', 'Walang Anuman'], // Choices for second image
      ['Okay', 'Hindi Okay', 'Sige', 'Bakit'], // Choices for third image
      ['Salamat', 'Kumusta', 'Tama', 'Mali'], // Choices for fourth image
    ];

    correctAnswers = ['Kumusta', 'Salamat', 'Okay', 'Salamat']; // Correct answers corresponding to each question
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => TestCompletionPage(
          ...
          totalQuestions: imageUrls.length, // Pass the total number of questions
        ),
      ),
    );
  }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: constraints.maxHeight * 0.5, // Increased height for the card
                  width: constraints.maxWidth * 0.8, // Increased width for the card
                  child: UnawaCard(
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ElevatedButton(
                      onPressed: () => _onChoiceSelected(choices[currentIndex][index]),
